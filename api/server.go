...
// file is written on, and a push is held to it before anything is written for the reason it is
// held to commitName: the table's domain refuses a name off it too, but only at the insert, after
// the tree was already in the store with nothing counting it, and answered 500 for what was the
// caller's mistake.
