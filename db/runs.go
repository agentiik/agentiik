...
type NewRun struct {
	...
	// and happens before a run exists: the API binds them against the version's declaration
	// and writes what was bound, defaults included. A JSON object. Empty is none.
